...
class Attention(nn.Module):
    def __init__(self, encoder_dim, decoder_dim, attention_dimm):
        super(Attention, self).__init__()
        self.attention_dim = attention_dimm
        self.W = nn.Linear(decoder_dim, attention_dim)
        self_U = nn.Linear(encoder_dim, attention_dim)
...
class DecoderRNN(nn.Module):
    def __init__(self, embed_size, vocab_size, attention_dim, encoder_dim, decoder_dim,drop_prob=0.3):
        ...
        slef.drop = nn.Dropout(drop_prob)
    ...
    def generate_caption(self, features, max_len=20, vocab=None):
        ...
        for i in range(max_len):
            ...
            return [vocab.itospids for idx in captions], alphas
